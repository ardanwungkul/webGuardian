<!-- Main modal -->
<div id="editUser-{{ $user->id }}" tabindex="-1" aria-hidden="true"
    class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <form class="relative w-full max-w-2xl max-h-full" method="POST" action="{{ route('user.update', $user->id) }}">
        @csrf
        @method('PUT')
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-start justify-between px-6 py-3 border-b rounded-t dark:border-gray-600 cp-3">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="editUser-{{ $user->id }}">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div class="col-span-2">
                            ...
                            <input type="text" id="name" name="name"
                                ...
                                onfocus="this.removeAttribute('readonly');" value="{{ $user->name }}">
                        </div>
                        <div class="col-span-2">
                            <label for="username"
                            ...
                            <input type="text" id="username" name="username"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Masukkan Username" required readonly
                                onfocus="this.removeAttribute('readonly');" value="{{ $user->username }}">
                        </div>
                        <div class="col-span-2">
                            <label for="email"
                ...
                <div
                    ...
                    <button data-modal-hide="editUser-{{ $user->id }}" type="button"
