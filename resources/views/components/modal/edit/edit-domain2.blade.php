<!-- Main modal -->
<div id="editDomain2-{{ $domain->id }}" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-start justify-between px-6 py-3 border-b rounded-t dark:border-gray-600 cp-3">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="editDomain2-{{ $domain->id }}">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" id="link_report" name="report"
                                ...
                                class="linkReports bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div
                    ...
                    <button data-modal-hide="editDomain2-{{ $domain->id }}" type="button"
