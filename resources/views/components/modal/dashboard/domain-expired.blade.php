<!-- Main modal -->
<div id="showDomainExpired" tabindex="-1" aria-hidden="true"
    ...
    <form class="relative w-full max-w-2xl max-h-full" method="POST" action="{{ route('kategori.store') }}">
        @csrf
        @method('POST')
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="flex items-start justify-between px-6 py-3 border-b rounded-t dark:border-gray-600 cp-3">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="showDomainExpired">
                ...
                <div class="p-5 bg-white rounded-lg">
                    ...
                    <div class="rounded-lg h-[24rem] overflow-y-auto scrollbar-hide">
                        <table class="w-full text-left text-gray-500 dark:text-gray-400 rounded-lg"
                            ...
                            <tbody>
                                @foreach ($expiredDomains as $expired)
                                    <tr class="border-b bg-white text-black">
                                        <th class="px-10 py-2 text-left">{{ $expired->nama_domain }}</th>
                ...
                <div
                    ...
                    <button data-modal-hide="showDomainExpired" type="button"
